...
export class integrations1570172257753 implements MigrationInterface {
    ...
    if (Integration){
        ...
        await queryRunner.query('ALTER TABLE "intergrationdhisdataconnection" RENAME COLUMN "id" TO "intergrationdhisdataconnectionid"');
        ...
        await queryRunner.query('ALTER TABLE "intergrationtiisdataconnection" RENAME COLUMN "id" TO "intergrationtiisdataconnectionid"');
        ...
        await queryRunner.query('ALTER TABLE "intergrationtiisdataconnection" ADD COLUMN IF NOT EXISTS "uid" text');
        ...
        await queryRunner.query('ALTER TABLE "intergrationtiisdataconnection" ADD COLUMN IF NOT EXISTS "name" text');
