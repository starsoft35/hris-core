...
export class message1570092892299 implements MigrationInterface {
    ...
    if (Message){
        ...
        await queryRunner.query('ALTER TABLE "messagemetadata" ADD COLUMN IF NOT EXISTS "code" text');
        await queryRunner.query('ALTER TABLE "messagemetadata" ADD COLUMN IF NOT EXISTS "lastupdatedby" text');
        await queryRunner.query('ALTER TABLE "messagemetadata" ADD COLUMN IF NOT EXISTS "publicaccess" text');
        ...
        await queryRunner.query('ALTER TABLE "messagemetadata" ADD COLUMN IF NOT EXISTS "lastupdated" text');
        await queryRunner.query('ALTER TABLE "messagemetadata" ADD COLUMN IF NOT EXISTS "name" text');
        ...
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "lastupdated" text');
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "uid" text');
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "lastupdatedby" text');
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "publicaccess" text');
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "externalaccess" boolean');
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "code" text');
        await queryRunner.query('ALTER TABLE "messagethreadmetadata" ADD COLUMN IF NOT EXISTS "name" text');
        ...
        await queryRunner.query('ALTER TABLE "messagethread" ADD COLUMN IF NOT EXISTS "lastupdated" text');
        ...
        await queryRunner.query('ALTER TABLE "messagethread" ADD COLUMN IF NOT EXISTS "lastupdatedby" text');
        await queryRunner.query('ALTER TABLE "messagethread" ADD COLUMN IF NOT EXISTS "publicaccess" text');
        await queryRunner.query('ALTER TABLE "messagethread" ADD COLUMN IF NOT EXISTS "externalaccess" boolean');
        await queryRunner.query('ALTER TABLE "messagethread" ADD COLUMN IF NOT EXISTS "code" text');
        await queryRunner.query('ALTER TABLE "messagethread" ADD COLUMN IF NOT EXISTS "name" text');
        ...
        await queryRunner.query('ALTER TABLE "message" ADD COLUMN IF NOT EXISTS "lastupdated" text');
        ...
        await queryRunner.query('ALTER TABLE "message" ADD COLUMN IF NOT EXISTS "lastupdatedby" text');
        await queryRunner.query('ALTER TABLE "message" ADD COLUMN IF NOT EXISTS "publicaccess" text');
        await queryRunner.query('ALTER TABLE "message" ADD COLUMN IF NOT EXISTS "externalaccess" boolean');
        await queryRunner.query('ALTER TABLE "message" ADD COLUMN IF NOT EXISTS "code" text');
        await queryRunner.query('ALTER TABLE "message" ADD COLUMN IF NOT EXISTS "name" text');
