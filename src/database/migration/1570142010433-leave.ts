...
export class leave1570142010433 implements MigrationInterface {
    ...
    if (Leave){
        ...
        await queryRunner.query('ALTER TABLE "leave" RENAME COLUMN "id" TO "leaveid"');
        ...
        await queryRunner.query('ALTER TABLE "leave" ADD COLUMN IF NOT EXISTS "uid" text');
        ...
        await queryRunner.query('ALTER TABLE "leaverelative" ADD COLUMN IF NOT EXISTS "uid" text');
        await queryRunner.query('ALTER TABLE "leaverelative" ADD COLUMN IF NOT EXISTS "name" text');
        ...
        await queryRunner.query('ALTER TABLE "leavetype" RENAME COLUMN "id" TO "leaverelativeid"');
        ...
        await queryRunner.query('ALTER TABLE "leavetype" ADD COLUMN IF NOT EXISTS "uid" text');
