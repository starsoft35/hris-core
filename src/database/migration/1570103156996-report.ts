    ...
    'SELECT
      ...
      await queryRunner.query(`
                               INSERT INTO public.report(
                                 ...
                                 VALUES(uid(),'Trained Providers','{"ou": true,"pe": false,"training":{"sessions": true,"units": true,"curriculumn": true,"topics": true,"organizers": true,"sponsors": true,"qualifications": true,"delivery_mode": true,"providers": true,"dateRange": true}}', 'html', '<table id="data" class="dataTable table table-striped table-bordered table-hover no-footer" cellpadding="0" cellspacing="0" border="0">
