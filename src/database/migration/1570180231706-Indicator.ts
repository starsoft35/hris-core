...
//         await queryRunner.query("INSERT INTO indicator(id, uid, created, lastupdated, name, shortname, description, formid, expression, filter, aggregationtype, analyticstype)" +
