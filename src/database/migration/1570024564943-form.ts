...
//         await queryRunner.query('ALTER TABLE "form" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
//         await queryRunner.query('ALTER TABLE "form" ADD COLUMN IF NOT EXISTS "title" text');
//         await queryRunner.query('ALTER TABLE "form" ADD COLUMN IF NOT EXISTS "name" character varying(256)');
...
//         await queryRunner.query('ALTER TABLE "formsection" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
...
//         await queryRunner.query('ALTER TABLE "fieldoption" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
...
//         await queryRunner.query('ALTER TABLE "fieldoptionmerge" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
...
//         await queryRunner.query('ALTER TABLE "fieldoptionmerge" ADD COLUMN IF NOT EXISTS "uid" character varying(256)');
//         await queryRunner.query('ALTER TABLE "fieldoptionmerge" ADD COLUMN IF NOT EXISTS "code" character varying(25)');
...
//         await queryRunner.query('ALTER TABLE "fieldoptiongroupset" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
//         await queryRunner.query('ALTER TABLE "fieldoptiongroupset" ADD COLUMN IF NOT EXISTS "description" text');
//         await queryRunner.query('ALTER TABLE "fieldoptiongroupset" ADD COLUMN IF NOT EXISTS "name" character varying(256)');
//         await queryRunner.query('ALTER TABLE "fieldoptiongroupset" ADD COLUMN IF NOT EXISTS "uid" character varying(256)');
//         await queryRunner.query('ALTER TABLE "fieldoptiongroupset" ADD COLUMN IF NOT EXISTS "code" character varying(25)');
...
//         await queryRunner.query('ALTER TABLE "fieldoptiongroup" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
...
//         await queryRunner.query('ALTER TABLE "fieldoptionchildren" ADD COLUMN IF NOT EXISTS "uid" character varying(256)');
//         await queryRunner.query('ALTER TABLE "fieldoptionchildren" ADD COLUMN IF NOT EXISTS "code" character varying(25)');
...
//         await queryRunner.query('ALTER TABLE "fieldoptionchildren" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
...
//         await queryRunner.query('ALTER TABLE "fieldinputtype" ADD COLUMN IF NOT EXISTS "name" character varying(256)');
//         await queryRunner.query('ALTER TABLE "fieldinputtype" ADD COLUMN IF NOT EXISTS "htmltag" text');
//         await queryRunner.query('ALTER TABLE "fieldinputtype" ADD COLUMN IF NOT EXISTS "uid" character varying(256)');
...
//         await queryRunner.query('ALTER TABLE "fieldgroupset" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
//         await queryRunner.query('ALTER TABLE "fieldgroupset" ADD COLUMN IF NOT EXISTS "description" text');
//         await queryRunner.query('ALTER TABLE "fieldgroupset" ADD COLUMN IF NOT EXISTS "name" character varying(256)');
...
//         await queryRunner.query('ALTER TABLE "fielddatatype" ADD COLUMN IF NOT EXISTS "lastupdated" timestamp without time zone');
//         await queryRunner.query('ALTER TABLE "fielddatatype" ADD COLUMN IF NOT EXISTS "description" text');
//         await queryRunner.query('ALTER TABLE "fielddatatype" ADD COLUMN IF NOT EXISTS "name" character varying(256)');
