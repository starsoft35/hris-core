...
export class organizationunit1570005706748 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        if (organizationUnit){
            ...
            await queryRunner.query('ALTER TABLE "organisationunit" ADD COLUMN IF NOT EXISTS "code" text');
            await queryRunner.query('ALTER TABLE "organisationunit" ADD COLUMN IF NOT EXISTS "publicaccess" text');
            await queryRunner.query('ALTER TABLE "organisationunit" ADD COLUMN IF NOT EXISTS "externalaccess" boolean');
            await queryRunner.query('ALTER TABLE "organisationunit" RENAME COLUMN "phoneinteger" TO "phonenumber"');
            ...
            await queryRunner.query('ALTER TABLE "organisationunit" ADD COLUMN IF NOT EXISTS "lastupdated" text');
            await queryRunner.query('ALTER TABLE "organisationunit" ADD COLUMN IF NOT EXISTS "name" text');  
            await queryRunner.query('ALTER TABLE "organisationunit" ADD COLUMN IF NOT EXISTS "lastupdatedby" text');
            ...
            await queryRunner.query('ALTER TABLE "organisationunitlevel" ADD COLUMN IF NOT EXISTS "publicaccess" text');
            await queryRunner.query('ALTER TABLE "organisationunitlevel" ADD COLUMN IF NOT EXISTS "externalaccess" boolean');
            await queryRunner.query('ALTER TABLE "organisationunitlevel" ADD COLUMN IF NOT EXISTS "code" text');
            await queryRunner.query('ALTER TABLE "organisationunitlevel" ADD COLUMN IF NOT EXISTS "lastupdatedby" text');
