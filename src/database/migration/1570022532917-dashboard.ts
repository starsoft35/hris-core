...
(
    ...
    userGroupAccesses jsonb,
    columns jsonb,
    dataElementDimensions jsonb,
    favorite boolean,
    parentGraphMap jsonb,
    topLimit integer,
    dataDimensionItems jsonb,
    categoryOptionGroupSetDimensions jsonb,
    organisationUnitGroupSetDimensions jsonb,
    filters jsonb,
    access jsonb,
    programIndicatorDimensions jsonb,
    attributeValues jsonb,
    userAccesses jsonb,
    categoryDimensions jsonb,
    dataElementGroupSetDimensions jsonb,
    attributeDimensions jsonb,
    displayName varying(40) COLLATE pg_catalog."default" NOT NULL,
...
TABLESPACE pg_default
    ...
    (
        ...
        "interpretationLikeCount" integer,
        href text,  
