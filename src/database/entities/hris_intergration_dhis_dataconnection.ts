...
@Index("unique_serverdatasetname_idx",["dataset_name","host_url",],{unique:true})
@Index("unique_serverdatasetuid_idx",["dataset_uid","host_url",],{unique:true})
...
export class hris_intergration_dhis_dataconnection {
    ...
    @OneToMany(type=>hris_intergration_dhis_dataelementfieldoptionrelation, hris_intergration_dhis_dataelementfieldoptionrelation=>hris_intergration_dhis_dataelementfieldoptionrelation.dhis_data_connection_,{ onDelete: 'CASCADE' , })
    hris_intergration_dhis_dataelementfieldoptionrelations:hris_intergration_dhis_dataelementfieldoptionrelation[];
    

   
    @ManyToMany(type=>hris_fieldoptiongroupset, hris_fieldoptiongroupset=>hris_fieldoptiongroupset.hris_intergration_dhis_dataconnections,{  nullable:false, })
