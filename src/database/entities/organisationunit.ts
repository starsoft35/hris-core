...
export class OrganisationUnit {
    ...
    @ManyToOne(type => OrganisationUnit, OrganisationUnit => OrganisationUnit.OrganisationUnits,{ onDelete: 'CASCADE', })
    ...
    @OneToMany(type => OrganisationUnit, OrganisationUnit => OrganisationUnit.parent_,{ onDelete: 'CASCADE' , })
    ...
    @OneToMany(type => Record, Record => Record.organisationunit_,{ onDelete: 'CASCADE' , })
    records: Record[];
