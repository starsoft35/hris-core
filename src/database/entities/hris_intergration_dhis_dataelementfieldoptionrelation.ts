...
@Index("unique_dhisdataelement_idx",["categorycombouid","dataelementuid","dhis_data_connection_",],{unique:true})
@Index("unique_hrfieldoptiongroups_idx",["column_fieldoption_group_","dhis_data_connection_","row_fieldoption_group_",],{unique:true})
...
export class hris_intergration_dhis_dataelementfieldoptionrelation {
    ...
    @ManyToOne(type=>hris_intergration_dhis_dataconnection, hris_intergration_dhis_dataconnection=>hris_intergration_dhis_dataconnection.hris_intergration_dhis_dataelementfieldoptionrelations,{ primary:true, nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'dhis_data_connection_id'})
    dhis_data_connection_:hris_intergration_dhis_dataconnection | null;


   
    @ManyToOne(type=>hris_fieldoptiongroup, hris_fieldoptiongroup=>hris_fieldoptiongroup.hris_intergration_dhis_dataelementfieldoptionrelations,{ onDelete: 'CASCADE', })
    @JoinColumn({ name:'column_fieldoption_group_id'})
    column_fieldoption_group_:hris_fieldoptiongroup | null;


   
    @ManyToOne(type=>hris_fieldoptiongroup, hris_fieldoptiongroup=>hris_fieldoptiongroup.hris_intergration_dhis_dataelementfieldoptionrelations2,{ onDelete: 'CASCADE', })
