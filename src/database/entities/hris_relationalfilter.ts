...
export class hris_relationalfilter {
    ...
    @ManyToOne(type=>hris_field, hris_field=>hris_field.hris_relationalfilters,{ onDelete: 'CASCADE', })
    ...
    @ManyToMany(type=>hris_friendlyreport, hris_friendlyreport=>hris_friendlyreport.hris_relationalfilters)
    hris_friendlyreports:hris_friendlyreport[];
    

   
    @ManyToMany(type=>hris_fieldoption, hris_fieldoption=>hris_fieldoption.hris_relationalfilters,{  nullable:false, })
