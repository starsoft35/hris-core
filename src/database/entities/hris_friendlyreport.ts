...
export class hris_friendlyreport {
    ...
    @ManyToOne(type=>hris_fieldoptiongroup, hris_fieldoptiongroup=>hris_fieldoptiongroup.hris_friendlyreports,{ onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>hris_friendlyreportcategory, hris_friendlyreportcategory=>hris_friendlyreportcategory.friendlyreport_,{ onDelete: 'CASCADE' , })
    hris_friendlyreportcategorys:hris_friendlyreportcategory[];
    

   
    @ManyToMany(type=>hris_arithmeticfilter, hris_arithmeticfilter=>hris_arithmeticfilter.hris_friendlyreports,{  nullable:false, })
    @JoinTable({ name:'hris_friendlyreport_arithmeticfilter'})
    hris_arithmeticfilters:hris_arithmeticfilter[];
    

   
    @ManyToMany(type=>hris_relationalfilter, hris_relationalfilter=>hris_relationalfilter.hris_friendlyreports,{  nullable:false, })
