...
hris_relationalfilter = __decorate([
    ...
    typeorm_1.Index('idx_629c17cd443707b0', ['field_']),
    typeorm_1.Index('uniq_629c17cd5e237e06', ['name'], { unique: true }),
    typeorm_1.Index('uniq_629c17cd539b0606', ['uid'], { unique: true })
