...
export class hris_indicator_target {
    ...
    @ManyToOne(type=>hris_organisationunitgroup, hris_organisationunitgroup=>hris_organisationunitgroup.hris_indicator_targets,{ onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>hris_indicator_targetfieldoption, hris_indicator_targetfieldoption=>hris_indicator_targetfieldoption.target_,{ onDelete: 'CASCADE' , })
