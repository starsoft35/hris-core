...
hris_intergration_dhis_dataconnection = __decorate([
    ...
    typeorm_1.Index('unique_serverdatasetname_idx', ['dataset_name', 'host_url'], {
        unique: true,
    }),
    typeorm_1.Index('unique_serverdatasetuid_idx', ['dataset_uid', 'host_url'], {
        unique: true,
    }),
    typeorm_1.Index('idx_c47f616d4108d2f5', ['parent_organisationunit_']),
    typeorm_1.Index('uniq_c47f616d539b0606', ['uid'], { unique: true })
