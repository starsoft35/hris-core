...
export class hris_intergration_tiis_data_connection {
    ...
    @OneToOne(type=>hris_intergration_tiis_employee_fieldrelation, hris_intergration_tiis_employee_fieldrelation=>hris_intergration_tiis_employee_fieldrelation.tiis_data_connection_,{ onDelete: 'CASCADE' , })
