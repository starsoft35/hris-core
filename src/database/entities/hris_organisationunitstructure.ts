...
export class hris_organisationunitstructure {
  ...
  //       hris_organisationunit.hris_organisationunitstructure,
  ...
  //   @ManyToOne(
  //     type => hris_organisationunitlevel,
  //     hris_organisationunitlevel =>
  //       hris_organisationunitlevel.hris_organisationunitstructures,
  //     { onDelete: 'CASCADE' },
  //   )
  ...
  //     type => hris_organisationunit,
  //     hris_organisationunit =>
  //       hris_organisationunit.hris_organisationunitstructures,
  //     { onDelete: 'CASCADE' },
  //   )
  ...
  //     type => hris_organisationunit,
  //     hris_organisationunit =>
  //       hris_organisationunit.hris_organisationunitstructures2,
  //     { onDelete: 'CASCADE' },
  //   )
  ...
  //     type => hris_organisationunit,
  //     hris_organisationunit =>
  //       hris_organisationunit.hris_organisationunitstructures3,
  //     { onDelete: 'CASCADE' },
  //   )
  ...
  //     type => hris_organisationunit,
  //     hris_organisationunit =>
  //       hris_organisationunit.hris_organisationunitstructures4,
  //     { onDelete: 'CASCADE' },
  //   )
  ...
  //     type => hris_organisationunit,
  //     hris_organisationunit =>
  //       hris_organisationunit.hris_organisationunitstructures5,
  //     { onDelete: 'CASCADE' },
  //   )
  ...
  //     type => hris_organisationunit,
  //     hris_organisationunit =>
  //       hris_organisationunit.hris_organisationunitstructures6,
  //     { onDelete: 'CASCADE' },
  //   )
