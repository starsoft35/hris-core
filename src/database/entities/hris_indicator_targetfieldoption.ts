...
export class hris_indicator_targetfieldoption {
    ...
    @ManyToOne(type=>hris_indicator_target, hris_indicator_target=>hris_indicator_target.hris_indicator_targetfieldoptions,{ primary:true, nullable:false,onDelete: 'CASCADE', })
    @JoinColumn({ name:'target_id'})
    target_:hris_indicator_target | null;


   
    @ManyToOne(type=>hris_fieldoption, hris_fieldoption=>hris_fieldoption.hris_indicator_targetfieldoptions,{ primary:true, nullable:false,onDelete: 'CASCADE', })
