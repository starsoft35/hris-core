...
@Index("arithmetic_filter_idx",["leftexpression","operator","rightexpression",],{unique:true})
...
export class hris_arithmeticfilter {
    ...
    @ManyToMany(type=>hris_friendlyreport, hris_friendlyreport=>hris_friendlyreport.hris_arithmeticfilters)
