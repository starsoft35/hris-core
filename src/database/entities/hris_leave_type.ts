...
export class hris_leave_type {
    ...
    @OneToOne(type=>hris_fieldoption, hris_fieldoption=>hris_fieldoption.hris_leave_type,{ onDelete: 'CASCADE', })
    ...
    @OneToMany(type=>hris_leave, hris_leave=>hris_leave.leave_type_,{ onDelete: 'CASCADE' , })
