...
let RecordService = class RecordService extends base_service_1.BaseService {
    constructor(recordRepository) {
        super(recordRepository, record_entity_1.Record);
    }
};
RecordService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(record_entity_1.Record)),
