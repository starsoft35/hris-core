...
const field_group_service_1 = require("../services/field-group.service");
const base_contoller_1 = require("src/core/controllers/base.contoller");
let FieldGroupController = class FieldGroupController extends base_contoller_1.BaseController {
    constructor(service) {
        super(service, field_group_entity_1.FieldGroup);
    }
};
FieldGroupController = __decorate([
    common_1.Controller('api/' + field_group_entity_1.FieldGroup.plural),
