...
let FieldService = class FieldService extends base_service_1.BaseService {
    constructor(repository) {
        super(repository, field_entity_1.Field);
    }
};
FieldService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_2.InjectRepository(field_entity_1.Field)),
