...
let MessageThreadService = class MessageThreadService extends base_service_1.BaseService {
    constructor(messageThreadService) {
        super(messageThreadService, message_thread_entity_1.MessageThread);
    }
};
MessageThreadService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(message_thread_entity_1.MessageThread)),
