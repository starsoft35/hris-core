...
let FormController = class FormController extends base_contoller_1.BaseController {
    constructor(service) {
        super(service, form_entity_1.Form);
    }
};
FormController = __decorate([
    common_1.Controller('api/' + form_entity_1.Form.plural),
