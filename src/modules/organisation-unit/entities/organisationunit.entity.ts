...
import { hris_intergration_dhis_dataconnection } from '../../../database/entities/hris_intergration_dhis_dataconnection';
import { hris_intergration_tiis_data_connection } from '../../../database/entities/hris_intergration_tiis_data_connection';
import { hris_organisationunitcompleteness } from '../../../database/entities/hris_organisationunitcompleteness';
import { hris_organisationunitgroup } from '../../../database/entities/hris_organisationunitgroup';
import { hris_organisationunitstructure } from '../../../database/entities/hris_organisationunitstructure';
import { hris_traininginstance } from '../../../database/entities/hris_traininginstance';
...
@Index('organisationunits_with_one_parent_idx', ['longname', 'parent_'], {
  unique: true,
})
...
export class OrganisationUnit {
  ...
  @OneToMany(
    type => OrganisationUnit,
    OrganisationUnit => OrganisationUnit.parent_,
    { onDelete: 'CASCADE' },
  )
  ...
  @OneToMany(
    ...
    hris_organisationunitcompleteness =>
      hris_organisationunitcompleteness.organisationunit_,
    { onDelete: 'CASCADE' },
  )
  ...
  @ManyToMany(
    ...
    hris_organisationunitgroup =>
      hris_organisationunitgroup.hris_organisationunits,
  )
